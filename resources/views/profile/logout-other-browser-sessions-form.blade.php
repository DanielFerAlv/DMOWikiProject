<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Gestione o desconecte sus sesiones activas en otros dispositivos y navegadores') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div>
            {{ __('De ser necesario, puede desconectar las sesiones de todos los demás navegadores y dispositivos. Alguna de sus sesiones recientes están listadas abajo; de todas formas, esta lista puede no ser exhaustiva. Si cree que su cuenta ha sido comprometida, debería cambiar su contraseña.') }}
        </div>
        ...
        <div class="d-flex mt-3">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Desconectar otras sesiones de navegador') }}
            </x-jet-button>
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor, introduzca su contraseña para confirmar que quiere cerrar sesión en otros navegadores y dispositivos. ') }}
